...
export default function BottomMobileNav() {
  ...
  return (
    <div
      className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-zinc-100 dark:bg-zinc-900/95 backdrop-blur-lg border-t border-zinc-200 dark:border-zinc-800 shadow-[0_-4px_20px_rgba(0,0,0,0.05)] dark:shadow-[0_-4px_20px_rgba(0,0,0,0.2)] pb-safe"
    >
