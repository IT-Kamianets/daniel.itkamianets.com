  ...
  return (
    <section id="delivery" className="py-10 md:py-16 bg-white dark:bg-zinc-950">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Progress Bar */}
        <div className="flex justify-between items-center mb-8 md:mb-12 relative max-w-2xl mx-auto">
          ...
          {[
            { num: 1, icon: ShoppingBag, label: t("cart") },
            { num: 2, icon: MapPin, label: t("delivery") },
            { num: 3, icon: CreditCard, label: t("confirm") },
          ].map((s, index) => (
            <div key={s.num} className="flex items-center">
              <div className="flex flex-col items-center gap-2 relative z-10 bg-white dark:bg-zinc-950 px-2">
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-full flex items-center justify-center transition-colors duration-500 ${
                    step >= s.num
                ...
                <span
                  className={`text-[10px] md:text-xs font-medium ${step >= s.num ? "text-zinc-900 dark:text-white" : "text-zinc-400"}`}
                >
                  {s.label}
                </span>
              </div>
              {index < 2 && (
                <div className="hidden md:block absolute left-[calc(16%+20px)] w-[30%] text-zinc-300 dark:text-zinc-700" style={{ left: index === 0 ? '25%' : '75%', transform: 'translateX(-50%)' }}>
                  <ChevronRight size={24} className={step > s.num ? "text-orange-500" : ""} />
                </div>
              )}
            </div>
          ))}
        ...
        {/* Form Container */}
        <div className="bg-white dark:bg-zinc-950 rounded-3xl p-4 md:p-6 shadow-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden relative min-h-[350px] md:min-h-[400px]">
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                    ...
                    {items.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3 md:gap-4">
                          <div className="flex items-center gap-1 md:gap-2 bg-white dark:bg-zinc-950 rounded-lg p-1 border border-zinc-200 dark:border-zinc-800">
                            <button
                          ...
                          <div className="font-bold text-orange-500 w-14 md:w-16 text-right text-sm">
                ...
                {items.length > 0 && (
                  <>
                    <div className="flex justify-between items-center pt-4 md:pt-6 border-t border-zinc-200 dark:border-zinc-800">
                    ...
                    <div className="flex justify-end pt-2 md:pt-4">
                      <button
                        onClick={nextStep}
                        className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-3 md:px-8 md:py-4 rounded-xl font-bold transition-colors text-sm md:text-base"
                      >
            ...
            {step === 2 && (
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                  ...
                  {/* Mock Map */}
                  <div className="bg-zinc-100 dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-200 dark:border-zinc-800 relative min-h-[150px] md:min-h-[200px]">
                    <div
                ...
                <div className="flex justify-between pt-4 md:pt-6 border-t border-zinc-200 dark:border-zinc-800">
                  <button
                    onClick={prevStep}
                    className="flex items-center gap-2 text-zinc-500 hover:text-zinc-900 dark:hover:text-white px-4 py-3 md:px-6 md:py-4 rounded-xl font-bold transition-colors text-sm md:text-base"
                  >
            ...
            {step === 3 && (
              ...
              >
                ...
                <button
                  ...
                  className="bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-900 dark:text-white px-6 py-3 md:px-8 md:py-4 rounded-xl font-bold transition-colors text-sm md:text-base"
                >
                  {t("backToMenu")}
                </button>
              </motion.div>
